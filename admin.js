// HDV Admin v3.0 - Dashboard, Toast, Confirm, Activity Log, Stock Alerts
// Variables globales
let todosLosPedidos = [];
...
function crearBackup() {
    const backup = { fecha: new Date().toISOString(), version:'3.0', datos:{ productos:productosData, pedidos:todosLosPedidos, actividad: JSON.parse(localStorage.getItem('hdv_actividad')||'[]') } };
